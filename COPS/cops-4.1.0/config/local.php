...
/*
 * Use "kindle" style as default - this isn't the prettiest, but works well with eReaders where changing style is]
 * often difficult.  Customize page allows change to style used by each user with setting stored in a cookie
 * Note: this is not the same as the template - it only changes the CSS used to display the page
 */
$config['cops_style'] = 'kindle';
