...
- epubjs browser based epub reader has some great features but may not work great on small screens such as smart phones. Currently epubjs is the default reader, but you can switch to monacle in the config if you have problems.
