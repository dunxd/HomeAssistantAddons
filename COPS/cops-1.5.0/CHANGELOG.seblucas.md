# Change Log for COPS (original)

For the forked releases 1.2.0 and beyond see [CHANGELOG](CHANGELOG.md)
or directly at https://github.com/mikespub-org/seblucas-cops/blob/main/CHANGELOG.md
